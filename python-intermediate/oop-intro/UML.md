A class is a blueprint. So much so that we can use a [class diagram](https://en.wikipedia.org/wiki/Class_diagram) to represent all of its properties and attributes.
